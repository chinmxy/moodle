...
$sql = "select password from admin where admin_no = $currentid";
...
if (isset($_POST['pass-change-button'])) {
  ...
  if ($new_pass_1 != $new_pass_2) {
    ...
    $sql3 = "update admin set password = '$new_pass_1' where admin_no = $currentid";
    ...
    -->
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="../accept_reject/accept_teacher.php">Accept/Reject teachers</a>
              <!--<div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Something else here</a>
        </div>-->
          </li>
