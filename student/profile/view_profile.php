...
$sql = "select name from student where rollno = $currentid";
...
$sql1 = "select elective_name from student where rollno = $currentid";
$result = mysqli_query($conn, $sql1);

if (mysqli_num_rows($result) > 0) {

  while ($row = mysqli_fetch_assoc($result)) {
    $elec = $row["elective_name"];
    if ($elec == '') {
      $elec = 'NA';
    }
  }
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form>
          ...
          <h5>Elective:</h5>
          <input type='text' value='<?php echo $elec; ?>' disabled>
